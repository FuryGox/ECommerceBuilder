...
export default function Home() {
  return (
    <div>
      <div className="items-center justify-center min-h-screen w-full font-[family-name:var(--font-geist-sans)]">
        <Header />
        <div
          className="flex flex-col w-full mt-16 items-center justify-center sm:items-start "
